...
import { Calculator, User, Scale, Ruler } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Hitung kebutuhan harian energi, protein, lemak, karbohidrat, serat, dan air berdasarkan 
            data antropometri Anda
          </p>
        </div>
